...
// Using Mode3
//
#define _DRVUART_SET_DIVIDER(u32Port,u16Divider)            outp32(&UART0->BAUD + u32Port,(0x3<<28)|(u16Divider))    
...
typedef enum 
{
     ...
     // Wake up interrupt
     //
     DRVUART_WAKEUPINT    =     BIT6,        
     //
     // Buffer Error Interrupt
     //
     DRVUART_BUFERRINT  =     BIT5,        
     //
     // RX Time out Interrupt
     //
     DRVUART_TOUTINT       =     BIT4,        
     //
